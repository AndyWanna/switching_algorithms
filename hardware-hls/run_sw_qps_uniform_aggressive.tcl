# ============================================================================
# SW-QPS HLS TCL Script - UNIFORM TRAFFIC (AGGRESSIVE)
# ============================================================================

# Open project
open_project -reset sw_qps_project_uniform_aggressive
...
# Add testbench files
add_files -tb tb/tb_sw_qps_uniform.cpp
add_files -tb tb/tb_sw_qps_pure.cpp -cflags "-std=c++11 -DSW_QPS_PURE_DISABLE_MAIN"

# Open solution
open_solution "solution-uniform-aggressive"
...
# ============================================================================
puts "========================================="
puts "Step 2: Running Synthesis - UNIFORM AGGRESSIVE..."
puts "========================================="
...
# ============================================================================
puts "========================================="
puts "Step 3: Running Co-Simulation - UNIFORM AGGRESSIVE..."
puts "========================================="

cosim_design -O -trace_level all

puts "========================================="
puts "UNIFORM AGGRESSIVE Traffic Flow Complete!"
puts "========================================="
