/*
 * ============================================================================
 * SW-QPS HLS CO-SIMULATION TESTBENCH - DIAGONAL TRAFFIC
 * ============================================================================
 * 
...
// Bernoulli traffic generator - DIAGONAL ONLY
...
void testSWQPS(
    ...
    // Save to CSV
    monitor.saveToCSV("sw_qps_diagonal_results.csv", offered_load, pattern);
}

int main() {
    cout << "========================================" << endl;
    cout << "SW-QPS HLS - DIAGONAL TRAFFIC" << endl;
    cout << "========================================" << endl;
    ...
    cout << "\n========================================" << endl;
    cout << "DIAGONAL TRAFFIC TESTS COMPLETED!" << endl;
    cout << "Results saved to: sw_qps_diagonal_results.csv" << endl;
    cout << "========================================" << endl;
