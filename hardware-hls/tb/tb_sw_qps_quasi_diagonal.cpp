/*
 * ============================================================================
 * SW-QPS HLS CO-SIMULATION TESTBENCH - QUASI-DIAGONAL TRAFFIC
 * ============================================================================
 * 
...
// Bernoulli traffic generator - QUASI-DIAGONAL ONLY
...
void testSWQPS(
    ...
    // Save to CSV
    monitor.saveToCSV("sw_qps_quasi_diagonal_results.csv", offered_load, pattern);
}

int main() {
    cout << "========================================" << endl;
    cout << "SW-QPS HLS - QUASI-DIAGONAL TRAFFIC" << endl;
    cout << "========================================" << endl;
    ...
    cout << "\n========================================" << endl;
    cout << "QUASI-DIAGONAL TRAFFIC TESTS COMPLETED!" << endl;
    cout << "Results saved to: sw_qps_quasi_diagonal_results.csv" << endl;
    cout << "========================================" << endl;
