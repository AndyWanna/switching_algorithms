<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" top="sw_qps_top" name="sw_qps_project_diagonal" ideType="classic">
    <files>
        ...
        <file name="../../tb/tb_sw_qps_diagonal.cpp" sc="0" tb="1" cflags="-Wno-unknown-pragmas" csimflags="" blackbox="false"/>
    </files>
    <solutions>
        <solution name="solution-diagonal" status=""/>
    </solutions>
</AutoPilot:project>
