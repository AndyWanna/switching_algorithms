# ============================================================================
# SW-QPS HLS TCL Script - UNIFORM TRAFFIC
# ============================================================================

# Open project
open_project -reset sw_qps_project_uniform
...
# Open solution
open_solution "solution-uniform"
...
# ============================================================================
puts "========================================="
puts "Step 2: Running Synthesis - UNIFORM..."
puts "========================================="
...
# ============================================================================
puts "========================================="
puts "Step 3: Running Co-Simulation - UNIFORM..."
puts "========================================="
...
puts "========================================="
puts "UNIFORM Traffic Flow Complete!"
puts "========================================="
