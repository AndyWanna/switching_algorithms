# ============================================================================
# SW-QPS HLS TCL Script - LOG-DIAGONAL TRAFFIC (AGGRESSIVE)
# ============================================================================

# Open project
open_project -reset sw_qps_project_log_diagonal_aggressive
...
# Open solution
open_solution "solution-log-diagonal-aggressive"
...
# ============================================================================
puts "========================================="
puts "Step 2: Running Synthesis - LOG-DIAGONAL AGGRESSIVE..."
puts "========================================="
...
# ============================================================================
puts "========================================="
puts "Step 3: Running Co-Simulation - LOG-DIAGONAL AGGRESSIVE..."
puts "========================================="

cosim_design -O -trace_level all

puts "========================================="
puts "LOG-DIAGONAL AGGRESSIVE Traffic Flow Complete!"
puts "========================================="
