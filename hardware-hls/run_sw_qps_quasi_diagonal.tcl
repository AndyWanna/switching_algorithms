# ============================================================================
# SW-QPS HLS TCL Script - QUASI-DIAGONAL TRAFFIC
# ============================================================================

# Open project
open_project -reset sw_qps_project_quasi_diagonal
...
# Open solution
open_solution "solution-quasi-diagonal"
...
# ============================================================================
puts "========================================="
puts "Step 2: Running Synthesis - QUASI-DIAGONAL..."
puts "========================================="
...
# ============================================================================
puts "========================================="
puts "Step 3: Running Co-Simulation - QUASI-DIAGONAL..."
puts "========================================="
...
puts "========================================="
puts "QUASI-DIAGONAL Traffic Flow Complete!"
puts "========================================="
