# ============================================================================
# SW-QPS HLS TCL Script - QUASI-DIAGONAL TRAFFIC (AGGRESSIVE)
# ============================================================================

# Open project
open_project -reset sw_qps_project_quasi_diagonal_aggressive
...
# Add testbench files
add_files -tb tb/tb_sw_qps_quasi_diagonal.cpp
add_files -tb tb/tb_sw_qps_pure.cpp -cflags "-std=c++11 -DSW_QPS_PURE_DISABLE_MAIN"

# Open solution
open_solution "solution-quasi-diagonal-aggressive"
...
# ============================================================================
puts "========================================="
puts "Step 2: Running Synthesis - QUASI-DIAGONAL AGGRESSIVE..."
puts "========================================="
...
# ============================================================================
puts "========================================="
puts "Step 3: Running Co-Simulation - QUASI-DIAGONAL AGGRESSIVE..."
puts "========================================="

cosim_design -O -trace_level all

puts "========================================="
puts "QUASI-DIAGONAL AGGRESSIVE Traffic Flow Complete!"
puts "========================================="
